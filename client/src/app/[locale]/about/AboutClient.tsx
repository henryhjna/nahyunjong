                          ...
                          <div className="flex items-start justify-between gap-4">
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 mt-1 text-xs text-text-tertiary">
                                ...
                                <span>{new Date(item.published_at).toLocaleDateString(locale === 'ko' ? 'ko-KR' : 'en-US')}</span>
                              </div>
                            </div>
                          ...
                          <div className="ml-4 mt-1 space-y-1 border-l-2 border-border pl-4">
                            {related.map((sub: any) => (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="block py-2 text-sm text-text-secondary hover:text-accent-blue transition-colors"
                              >
                                {l(sub.title, sub.title_en)}
                                {sub.source && <span className="text-text-tertiary ml-2">— {sub.source}</span>}
                              </a>
                            ))}
                          </div>
                        )}
