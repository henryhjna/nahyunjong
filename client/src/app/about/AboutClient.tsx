            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 mb-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-surface border border-border text-text-secondary text-sm hover:border-[#a6ce39] hover:text-[#a6ce39] transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-surface border border-border text-text-secondary text-sm hover:border-[#4285f4] hover:text-[#4285f4] transition-colors"
                >
