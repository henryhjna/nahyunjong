...
박유진은 거울 앞에 섰다. 32살, 화장품 회사에서 5년간 연구원으로 일하며 쌓은 노하우와 저축 1억원이 전부였다. 손에는 기술보증기금의 대출 승인 서류가 들려 있었다. 2억원. 떨리는 손으로 서류를 다시 한번 들여다봤다.

"정말 시작하는 거야? 안정적인 직장을 버리고?"

하지만 마음 한구석에선 이미 결정이 나 있었다. 지난 밤샘 실험실에서 완성한 그 포뮬러 - 민감성 피부를 위한 완벽한 세럼 - 가 머릿속을 맴돌았다.
...
📋 **계약 조건**
• 보증금: 10,000,000원 (계약 종료 시 반환)
• 월 임차료: 1,500,000원
• 특약사항: 6개월치 임차료 선납 시 10% 할인

"6개월치를 미리 내시면 900만원이에요. 한 달에 150만원씩 내시는 것보다 90만원 저렴하죠."

유진은 잠시 고민했다. 현금 흐름이 중요한 초기 스타트업에게 1,900만원은 작은 돈이 아니었다. 하지만 장기적으로는 이득이었다.

"알겠습니다. 보증금 천만원, 6개월치 임차료 900만원... 총 1,900만원 이체하겠습니다."
...
💻 **장비 리스트**
• MacBook Pro 14인치 (M1 Pro) × 3대
  - 내 것 1대, 앞으로 채용할 팀원용 2대
  - 1대당 1,500,000원 = 총 4,500,000원
...
🔧 **왜 한 번에 비용처리 안 하나요?**
• 500만원을 3월에 전액 비용처리하면?
  → 3월 손익이 왜곡돼요 (실제론 5년 쓸 건데!)

📊 **감가상각(Depreciation)**
• 5년간 나눠서 비용처리합니다
• 500만원 ÷ 5년 ÷ 12개월 = 월 83,333원
...
📦 **회계 처리**
• 제품을 받은 순간: 재고자산 150만원 증가 (자산 ↑)
• 아직 돈 안 냄: 매입채무 150만원 증가 (부채 ↑)
...
유진은 소리를 지르며 방방 뛰었다. 32살, 화장품 연구원에서 대표가 된 지 한 달 만에 첫 매출. 245만원이 적은 돈은 아니었지만, 그보다 더 중요한 건...
...
📉 **3월 비용**
• 임차료: 1,500,000원
• 감가상각비: 83,333원 (비품 500만원 ÷ 5년 ÷ 12개월)
• 무형자산상각비: 222,222원 (홈페이지 800만원 ÷ 3년 ÷ 12개월)
• 이자비용: 750,000원 (차입금 2억 × 4.5% ÷ 12개월)
